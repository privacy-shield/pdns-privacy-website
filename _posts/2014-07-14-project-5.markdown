...
<details class="fancy-collapse">
  ...
  <a href="{{ '/2014/07/16/project-3/' | relative_url }}">Installation Manual</a> before moving on to step 2
</li>
      </ol>
      <ol start="2">
  ...
  <a href="{{ '/2014/07/16/project-3/' | relative_url }}">Installation Manual</a></small>
      </ol>
...
<details class="fancy-collapse">
  ...
  <div class="inner">
    ...
    <p class="lead" style="font-size:1.5em; line-height:1.4;">
      ...
      <br><br>
      <img src="{{ '/img/router.jpg' | relative_url }}" alt="OpenWrt router" style="display:block; width:80%; max-width:620px; height:auto; border-radius:12px; margin:0 auto 20px;">
      <br><br>
