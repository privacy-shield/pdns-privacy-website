...
<!-- WRAPPED BLOCK -->
<p>
Below you’ll find instructions and tips to help you get started as a contributor. Set up your development environment, configure your IDE, and jump into writing code with minimal friction.
    ...
    <section class="dev-guide">
      ...
      <div class="video-frame">
        <video controls preload="metadata">
          <source src="{{ '/img/development-setup-h264.faststart.mp4' | relative_url }}" type="video/mp4">
          Your browser does not support the video tag.
        </video>
      </div>
      <ol>
        <li>Follow steps 1 and 2 from the
  <a href="{{ '#InstallManual' | relative_url }}" data-toggle="modal">Installation Manual</a> before moving on to step 2
</li>
      </ol>
      <ol start="2">
        <li>Create <code>launch.json</code> files for all 3 folders:</li>
        <small>Dont know where to get the arguments from?</small>
        <small>Follow step 3 from the
  <a href="{{ '#InstallManual' | relative_url }}" data-toggle="modal">Installation Manual</a></small>
      </ol>
...
<details class="fancy-collapse">
  ...
  <div class="inner">
    <section class="dev-guide">
    <ul>
      <h3 class="section-heading">Cross-Compilation Setup</h3>
      <ol>
      <li>
        <strong>Install Dependencies</strong>
        <div class="setup-panels">
          <details>
            <summary>Ubuntu / Debian  (WSL Dependent)</summary>
